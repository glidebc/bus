...
{!! Form::model($agent, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array(config('quickadmin.route').'.agent.update', $agent->id))) !!}
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      ...
      {!! link_to_route(config('quickadmin.route').'.agent.index', trans('quickadmin::templates.templates-view_edit-cancel'), null, array('class' => 'btn btn-default')) !!}
    </div>
</div>
